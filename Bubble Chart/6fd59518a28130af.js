// URL: https://beta.observablehq.com/d/6fd59518a28130af
// Title: Project 2
...
function task3(generatorx, generatory){
 ...
 //A color scale
  ...
  addcircles(svg,strTranslate(generatorx[0]),
             strTranslate(generatory[0]),
             strTranslate(a1),
             strTranslate(c1)
             ,1)

  addcircles(svg,strTranslate(generatorx[1]),
             strTranslate(generatory[1]),
             strTranslate(a2),
             strTranslate(c2),
             2)
  addcircles(svg,strTranslate(generatorx[2]),
             strTranslate(generatory[2]),
             strTranslate(a3),
             strTranslate(c3),
             3)
  addcircles(svg,strTranslate(generatorx[3]),
